 ...
 */
final class Version20200421082516 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chanteur ADD image VARCHAR(255) DEFAULT NULL, ADD updated_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE chanteur DROP image, DROP updated_at');
