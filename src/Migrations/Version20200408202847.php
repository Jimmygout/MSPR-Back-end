 ...
 */
final class Version20200408202847 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE objet_perdu ADD updated_at DATETIME NOT NULL, CHANGE map_id map_id INT DEFAULT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE objet_perdu DROP updated_at, CHANGE map_id map_id INT DEFAULT NULL, CHANGE image image VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE parking CHANGE map_id map_id INT DEFAULT NULL');
