 ...
 */
final class Version20200408194750 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reseaux_sociaux ADD image VARCHAR(255) DEFAULT NULL, ADD updated_at DATETIME NOT NULL');
