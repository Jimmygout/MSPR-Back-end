 ...
 */
final class Version20200413125605 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE parking ADD image VARCHAR(255) DEFAULT NULL, ADD updated_at DATETIME NOT NULL, CHANGE map_id map_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE parking DROP image, DROP updated_at, CHANGE map_id map_id INT DEFAULT NULL');
